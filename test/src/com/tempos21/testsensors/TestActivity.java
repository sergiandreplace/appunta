    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
     synchronized (this) {
      if (sensorEvent.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
       accelXValue.setText( Float.toString((int)(+sensorEvent.values[0])));
       accelYValue.setText(Float.toString((int)(+sensorEvent.values[1])));
       accelZValue.setText(Float.toString((int)(+sensorEvent.values[2])));       
      }
